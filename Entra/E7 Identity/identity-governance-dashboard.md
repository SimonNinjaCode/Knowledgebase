---
domain: m365-e7
id: "M365-ENTRA-IGD-001"
title: "Identity Governance dashboard - Microsoft Entra ID Governance"
sources: ["m365maps E7"]
ms-learn: "https://learn.microsoft.com/entra/id-governance/governance-dashboard"
created: 2026-05-30
updated: 2026-05-30
type: concept
...
# Identity Governance dashboard - Microsoft Entra ID Governance

## Översikt

Identity Governance Dashboard — en del av Microsoft 365 E7. Se [Microsoft Learn](https://learn.microsoft.com/entra/id-governance/governance-dashboard) för full dokumentation.
...
- If you have already deployed certain governance capabilities, use the dashboard to understand the coverage of your governance automations and find implementation gaps. For example, maybe you have automated birthright access using [entitlement management], but you have not set up periodic [access reviews]. Use the call-to-action links in the dashboard to further improve your identity governance posture.
...
## MS Learn-källa
[Identity Governance Dashboard](https://learn.microsoft.com/entra/id-governance/governance-dashboard)
