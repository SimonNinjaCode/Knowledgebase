...
ms-learn: "https://learn.microsoft.com/microsoft-365/copilot/extensibility/overview-copilot-connector"
created: 2026-05-30
updated: 2026-09-15
...
Det här är en funktionsreferens. Licens, roller och tillgänglighet kan ändras; se [Microsoft-dokumentationen](https://learn.microsoft.com/microsoft-365/copilot/extensibility/overview-copilot-connector).
...
For more information about federated connectors, see [Federated connectors overview].
...
![A screenshot of hovering over a Copilot connectors response in Microsoft 365 Copilot]

If users want to explore referenced content, they can select one of the links at the bottom of the response.

![A screenshot of Copilot connectors reference list in Microsoft 365 Copilot]
...
[Semantic labels] are used for filtering and don\'t affect semantic indexing. Federated connectors don\'t support semantic indexing.
...
## MS Learn-källa
[Graph and Connector Access](https://learn.microsoft.com/microsoft-365/copilot/extensibility/overview-copilot-connector)
